...
- reward of a step 
  ...
  - note: the reward function in RL is always meaningful / accurate / prepared
    ...
    - example2: in RLHF, the reward network is preparedly trained on the human feedback dataset before fine-tuning the LLM (i.e. policy network)
